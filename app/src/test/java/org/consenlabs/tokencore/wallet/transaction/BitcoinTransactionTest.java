...
public class BitcoinTransactionTest extends WalletSupport {
    ...
    public void testSignTxByHDWalletOnTestnet() {
        ...
        utxo.add(new BitcoinTransaction.UTXO(
                "983adf9d813a2b8057454cc6f36c6081948af849966f9b9a33e5b653b02f227a",//txHash:表示该输入是在哪个交易hash输出的
                0,//vout:表示在prev hash的那个交易的索引
                200000000,//amount:到账btc个数
                "mh7jj2ELSQUvRQELbn9qyA4q5nADhmJmUC",//address
                "76a914118c3123196e030a8a607c22bafc1577af61497d88ac",//scriptPubKey:锁定脚本，花费该UTXO时需要执行。
                "0/22"));//derivedPath


        utxo.add(new BitcoinTransaction.UTXO(
                "45ef8ac7f78b3d7d5ce71ae7934aea02f4ece1af458773f12af8ca4d79a9b531",
                1,
                200000000,
